 ...
 <!-- PAGE -->
                <div class="page">
                    <div class="">
                        ...
                        <!-- PAGE-CONTENT OPEN -->
                        <div class="page-content error-page error2 text-grey">
                            <div class="container text-center">
                                <div class="error-template">
                                    ...
                                    <h5 class="error-details">
                                        Leider ist ein Fehler aufgetreten. Die angeforderte Seite wurde nicht gefunden!
                                    </h5>
                                    <div class="text-center">
                                       <a class="btn btn-secondary mt-5 mb-5" href="https://getorganized.at/dashboard"> <i class="fa fa-long-arrow-left"></i> Zurück </a>
                                    </div>
                                </div>
                            </div>
                        </div>
